...
Let's take a look at the fisheries data. These data are already "tidy". To help with the next few examples, we'll gather the  species and catch count data using the `gather` function from the `tidyr` package.
