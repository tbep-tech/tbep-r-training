...
Download the zipped file of all the data from this [link](data/data.zip).  Unzip the content into a folder on your computer that you can access for the workshop.
