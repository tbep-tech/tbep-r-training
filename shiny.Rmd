...
* All input objects are defined in the `ui` file, given a name inside the `fooInput()` function (`foo` meaning generic, e.g., `plot`, `table`, etc.), and then referenced in the `server` file by `input$name` (`input$n` in this case). 
    ```{r, eval = F}
    numericInput(inputId = 'n', label = 'Sample size', value = 50)
    ```
